...
public class PercentageConfigOptionFabric extends PercentageConfigOption implements FabricConfigBuildable {

    public PercentageConfigOptionFabric(String key, int value) {
        super(key, value);
    }
