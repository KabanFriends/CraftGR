package sh.kaban.craftgr.config.entry.impl;

import dev.isxander.yacl3.api.Option;
import dev.isxander.yacl3.api.OptionDescription;
import sh.kaban.craftgr.config.ModConfig;
import sh.kaban.craftgr.config.controller.RadioStateController;
import sh.kaban.craftgr.config.entry.ConfigField;
import sh.kaban.craftgr.config.entry.OptionProvider;
